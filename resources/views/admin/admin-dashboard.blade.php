...
<div class="container py-5">
   ...
   <div class="row g-4 mb-4">
    <!-- Top row: Vendors and Customers -->
    <div class="col-6 col-md-6">
        <div class="card card-shopee text-center p-3">
            <h5 class="shopee-orange">🛍️ Vendors</h5>
            <h2>{{ $vendors }}</h2>
    ...
    <div class="col-6 col-md-6">
        <div class="card card-shopee text-center p-3">
            <h5 class="shopee-orange">👥 Customers</h5>
            <h2>{{ $customers }}</h2>
...
<div class="row g-4 mb-4">
    <!-- Bottom row: Products and Orders -->
    <div class="col-6 col-md-6">
        <div class="card card-shopee text-center p-3">
            <h5 class="shopee-orange">📦 Products</h5>
            <h2>{{ $products }}</h2>
    ...
    <div class="col-6 col-md-6">
        <div class="card card-shopee text-center p-3">
            <h5 class="shopee-orange">🧾 Orders</h5>
            <h2>{{ $orders }}</h2>
